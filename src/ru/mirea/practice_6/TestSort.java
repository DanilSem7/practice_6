...
public class TestSort {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Список №1:   " + Arrays.toString(student1));
        System.out.println("Список №2:   " + Arrays.toString(student2));

        System.out.println("(Список 1 + 2):   " + Arrays.toString(mergeSort(student1, student2)));
